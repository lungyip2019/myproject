...
// Todo change the checkout display into two field and change layout sortOrder in checkout#payment
...
class AddressLayoutProcessor
{
    ...
    public function afterProcess(LayoutProcessor $subject, array $jsLayout)
    {
        ...
        //  change telephone order in bank transfer
        $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['payments-list']['children']['banktransfer-form']['children']['form-fields']['children']['telephone']['sortOrder'] = 65;

        //  change telephone order in check/cash order
        $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['payments-list']['children']['checkmo-form']['children']['form-fields']['children']['telephone']['sortOrder'] = 65;
